...
const assessementBUtton = document.getElementById('assessment');
...
assessementBUtton.onclick = () => {
    ...
    if (userName.length === 0) { // 名前が時は処理を終了する
        return;
    }
...
console.assert(
    ...
    '入力が同じ名前なら同じ診断結果を出力する処理がただしくありせん。'
);
